# Load the Basketball Dataset to the environment by running the BasketballData script

# Load the Homework Challenge Dataset to the environment by running the HomeworkChallengeDataset Script
...
myplot <- function(basketballdata, players =1:10) 
{
  matplot(t(basketballdata[players,,drop=F]), type = "b", pch = 15 : 18, col = c(1:4,6), main = "Basketball Players Analysis")

  legend("bottomleft", inset = 0.01, legend = Players[players], col = c(1:4,6), pch =15 : 18, horiz = F)
}
